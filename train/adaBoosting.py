...
def load_ada_boosting_data(file_name, type):
    features = []
    labels = []
...
if __name__ == '__main__':
    ...
    for k in range(10):
        ...
        for i in range(epoch):
            ...
            train_features, test_features, train_labels, test_labels = load_ada_boosting_data(file_name, type=True)
            ...
            joblib.dump(clf, "../models/adaBoosting_model12-12-5.m")
            time_3 = time.time()
